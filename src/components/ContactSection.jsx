            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <h3 className="font-mono font-semibold text-lg sm:text-xl bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-teal-400">
                    Let's Connect
                  </h3>
              ...
              <Card className="border border-gray-500/50 dark:bg-gray-900/30 rounded-3xl shadow-md hover:shadow-xl transition-all duration-300">
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="font-mono font-semibold text-lg sm:text-xl text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-teal-400">
                    Send a Message
                  </h3>
